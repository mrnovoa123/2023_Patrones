package MVC_otro.pong;

/**
 * This is the model of the simple Pong game. It holds the properties of the
 * ball, paddle, and PongPanel. It also determines the movement of the ball.
 *
 * @author Tom Bylander
 */
public class PongModel {
    ...
    public PongModel() {
        ...
        ballX = 10000;
        ballY = 10000;
        ballDiameter = 20; //Exercicio 3.1. Modificar o tamaño da bola
        change = 1; //Exercicio 3.1. Modificar a velocidade da bola
        velocityX = change;
        velocityY = change;
        width = 0;
        height = 0;
