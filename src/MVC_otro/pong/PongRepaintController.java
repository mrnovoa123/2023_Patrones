...
public class PongRepaintController implements ActionListener {
    ...
    /**
     * Perform the needed actions when the timer goes off. When the timer goes
     * off, move the ball to its next position, determine if the number of hits
     * or misses changed, and repaint the window.
     */
