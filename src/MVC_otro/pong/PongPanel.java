...
/**
 * The PongPanel draws the paddle and the ball when repainted. This class along
 * with PongView implements the view part of the MVC pattern.
 *
 * @author Tom Bylander
 */
public class PongPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setColor(Color.GREEN);    //Exercicio 3.2
        ...
        g.setColor(Color.ORANGE);   //Exercicio 3.2
